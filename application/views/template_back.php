...
<head>
  ...
  <title>Dashboard Moviestation</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url()?>assets/back/dist/img/logofilm.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo base_url()?>assets/back/dist/img/logofilm.png" alt="" class="brand-image" style="opacity: .8">
