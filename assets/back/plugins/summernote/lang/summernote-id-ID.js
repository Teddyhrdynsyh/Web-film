  ...
  $.extend($.summernote.lang, {
    'id-ID': {
      ...
      image: {
        ...
        dragImageHere: 'Tarik nama_paket ke area ini',
        dropImage: 'Letakkan nama_paket atau teks',
        selectFromFiles: 'Pilih nama_paket dari berkas',
        maximumFileSize: 'Ukuran maksimal berkas',
        maximumFileSizeError: 'Ukuran maksimal berkas terlampaui.',
        url: 'URL nama_paket',
        remove: 'Hapus nama_paket',
        original: 'Original'
      },
      video: {
        video: 'Video',
